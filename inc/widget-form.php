...
<div class="widgin-widget-form">
	...
	<div class="widgin-section">
		...
		<fieldset data-fieldset-id="general" class="widgin-settings widgin-fieldset settings-general">
			...
			$general_fields = apply_filters( "advcatswdgt_form_fields_general", $_general_fields, $instance, $this );
	...
	<div class="widgin-section">
		...
		<fieldset data-fieldset-id="filters" class="widgin-settings widgin-fieldset settings-filters">
			...
			$intro = apply_filters( 'advcatswdgt_intro_text_filters', $_intro );
			?>
			...
			$filters_fields = apply_filters( "advcatswdgt_form_fields_filters", $_filters_fields, $instance, $this );
	...
	<div class="widgin-section">
		...
		<fieldset data-fieldset-id="thumbnails" class="widgin-settings widgin-fieldset settings-thumbnails">
			...
			<?php if( $thumb_compatible ) : ?>
				...
				$intro = apply_filters( 'advcatswdgt_intro_text_thumbnails', $_intro );
				?>
				...
				$thumbnail_fields = apply_filters( "advcatswdgt_form_fields_thumbnails", $_thumbnail_fields, $instance, $this );
	...
	<div class="widgin-section">
		...
		<fieldset data-fieldset-id="excerpts" class="widgin-settings widgin-fieldset settings-excerpts">
			...
			$excerpt_fields = apply_filters( "advcatswdgt_form_fields_excerpts", $_excerpt_fields, $instance, $this );
	...
	<div class="widgin-section">
		...
		<fieldset data-fieldset-id="meta" class="widgin-settings widgin-fieldset settings-meta">
			...
			$excerpt_fields = apply_filters( "advcatswdgt_form_fields_meta", $_excerpt_fields, $instance, $this );
	...
	<div class="widgin-section">
		...
		<fieldset data-fieldset-id="format" class="widgin-settings widgin-fieldset settings-format">
			...
			$format_fields = apply_filters( "advcatswdgt_form_fields_format", $_format_fields, $instance, $this );
	...
	<div class="widgin-section">
		...
		<fieldset data-fieldset-id="layout" class="widgin-settings widgin-fieldset settings-layout">
			...
			$intro = apply_filters( 'advcatswdgt_intro_text_layout', $_intro );
			?>
			...
			$layout_fields = apply_filters( "advcatswdgt_form_fields_layout", $_layout_fields, $instance, $this );
